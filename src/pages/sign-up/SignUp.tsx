...
const SignUp = () => {
    ...
    return (
        ...
        >
            ...
            <p className="text-start pl-3 pr-10 pt-3 text-lg xl:text-end">Have an account? <Link to='/login'><span className="text-primary-dark text-lg font-bold">Log in!</span></Link></p>
