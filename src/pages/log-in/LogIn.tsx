...
const LogIn = () => {
    ...
    return (
        ...
        >
            ...
            <p className="text-end pr-10 pt-3 text-lg">Don't have an account? <span className="text-primary-dark text-lg font-bold">Sign Up!</span></p>

            <div className='p-5 flex flex-col gap-3 max-w-[1366px]
            md:flex-row md:justify-center md:items-center md:h-full md:gap-30'>
                <div>
