...
const ActiveMarketplacesSection = () => {
    ...
    return (
        <div className="p-3 flex flex-col gap-3 bg-primary-light mt-6 md:px-5 h-full">
            <div className="w-full max-w-[1600px] mx-auto flex flex-col-reverse md:py-5 lg:flex-row">
