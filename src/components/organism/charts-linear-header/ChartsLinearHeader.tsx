        ...
        <div className="flex items-center px-13 flex-wrap gap-3">
            ...
            <div className="flex flex-wrap gap-3 xl:ml-[auto]">
                <div className="flex items-center">
                    ...
                    <div className="bg-background-primary-customized p-2 rounded-md">
                ...
                <div className="flex ml-3 items-center">
                    <Button className="text-xs text-foreground font-bold bg-primary-light w-30 py-5 mx-2 hover:text-white">By Brand</Button>
                    <Button className="text-xs text-foreground font-bold bg-primary-light w-30 py-5 mx-2 hover:text-white">Past 30 Days</Button>
                </div>
            </div>
