    ...
    <div className='p-3 flex flex-col gap-3 bg-primary-light mt-6 md:px-10'>
      <div className="w-full max-w-[1366px] mx-auto flex flex-col gap-5 md:p-5">
        ...
        <div className="flex justify-between items-end">
          <div>
            <h2 className="font-bold text-md">Default Max Price Settings</h2>
            <p className="text-sm">When new SKU’s are added, assign a Maximum Price based on the following priority rules:</p>
          </div>
        ...
        <div className="">
          ...
          <div className="md:flex items-center gap-10 mt-3 md:ml-30">
            <p className="font-bold text-sm">Max Price = Your Price + Shipping</p>
...
export default MaxPriceSettings