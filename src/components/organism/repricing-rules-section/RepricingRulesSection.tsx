    ...
    return (
        <div className="p-3 flex flex-col gap-3 bg-background-secondary-customized mt-1">
            ...
            <div className="flex justify-between items-center">
                ...
                <div>
                    <Button className="bg-primary-light text-foreground px-7 font-bold mr-3 hover:bg-violet-400">Add</Button>
                    <Button className="bg-violet-700 font-bold px-7 text-text-button-dark hover:bg-violet-400">Delete</Button>
                </div>
            </div>
